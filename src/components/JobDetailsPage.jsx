...
const JobDetailsPage = () => {
  ...
  // Calculate if job is student-friendly
        ...
        <div className="bg-white rounded-lg shadow-md p-6 max-w-3xl mx-auto">
          ...
          <div className="mb-6">
            <div className="flex justify-between items-start">
              ...
              {isStudentFriendly && (
                <div className="inline-flex items-center bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full">
          ...
          {/* Job details */}
          <JobDetails job={job} isStudentFriendly={isStudentFriendly} />
