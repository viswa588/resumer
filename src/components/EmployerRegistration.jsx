...
export default function EmployerRegistration() {
  ...
  const validateForm = () => {
    if (!formData.firstName || !formData.lastName || !formData.email || !formData.password || !formData.confirmPassword || !formData.companyName) {
      ...
      >
        <Card className="shadow-xl bg-white/90 backdrop-blur-md">
          <CardContent className="p-4 sm:p-6 md:p-8">
            <h2 className="text-center text-2xl md:text-3xl font-bold">Employer Registration</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="mt-4 text-center space-y-2">
                <p className="text-sm text-gray-600">
                  ...
                  <a onClick={() => navigate("/employer-login")} className="text-blue-600 hover:underline cursor-pointer">
                    Login
                  </a>
                </p>
                <p className="text-sm text-gray-600">
